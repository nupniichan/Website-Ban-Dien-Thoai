    ...
    datasets: [
      {
        ...
        borderColor: 'rgba(143, 153, 251, 1)',  // Màu đường nét
        backgroundColor: 'rgba(143, 153, 251, 0.2)',  // Màu nền dưới đường
        borderWidth: 2,
        fill: true,
  ...
  return (
    ...
    <div style={{ padding: '16px' }}>
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center" marginBottom="16px">
        {/* Doanh số và phần trăm thay đổi */}
        <Box>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse' }}>
            <thead>
              <tr style={{ backgroundColor: '#f5f5f5' }}>
                <th style={{ padding: '8px', border: '1px solid #ddd' }}>Mã sản phẩm</th>
            ...
            <tbody>
              <tr>
                <td style={{ padding: '8px', border: '1px solid #ddd' }}>IP16X2024</td>
            ...
            <tbody>
              <tr>
                ...
                <td style={{ padding: '8px', border: '1px solid #ddd' }}>Iphone 16</td>
                <td style={{ padding: '8px', border: '1px solid #ddd' }}>1 / nupniichan</td>
                <td style={{ padding: '8px', border: '1px solid #ddd' }}>16/09/2024 - 14:53 PM</td>
                <td style={{ padding: '8px', border: '1px solid #ddd' }}>1</td>
                <td style={{ padding: '8px', border: '1px solid #ddd' }}>$9.999</td>
            ...
            <tbody>
              <tr>
                ...
                <td style={{ padding: '8px', border: '1px solid #ddd' }}>Iphone 16</td>
                <td style={{ padding: '8px', border: '1px solid #ddd' }}>1 / nupniichan</td>
                <td style={{ padding: '8px', border: '1px solid #ddd' }}>16/09/2024 - 15:53 PM</td>
                <td style={{ padding: '8px', border: '1px solid #ddd' }}>1</td>
                <td style={{ padding: '8px', border: '1px solid #ddd' }}>$9.999</td>
