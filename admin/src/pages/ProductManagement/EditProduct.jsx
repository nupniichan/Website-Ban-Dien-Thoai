    ...
    const fetchProduct = async () => {
      try {
        ...
        if (response.ok) {
          ...
          // Kiểm tra nếu cauhinh là chuỗi JSON thì parse thành object
    ...
    <Box padding={3}>
      ...
      <form onSubmit={handleSubmit}>
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} sm={6}>
            <TextField label="Số lượng tồn" name="quantity" value={product.quantity} onChange={handleChange} fullWidth margin="normal" type="number" />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField label="Giá (VNĐ)" name="price" value={product.price} onChange={handleChange} fullWidth margin="normal" type="number" />
          </Grid>
          <Grid item xs={12} sm={6}>
