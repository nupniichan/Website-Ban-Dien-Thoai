  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!user.emailVerified) {
        setErrorMessage("Vui lòng xác minh email của bạn trước khi đăng nhập.");
        setShowResend(true);
        return;
      }
      ...
      const response = await fetch(`${BASE_URL}/api/login`, {
        ...
        body: JSON.stringify({ email: formData.email, password: formData.password }), // You may adjust this depending on your backend logic
      });
